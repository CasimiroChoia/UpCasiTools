...
function verificar() {
    ...
    if ( valor_obtido === aleatorio ) {         // CLAUSULA SE ACERTOU
        ...
        saida.innerHTML = ` infelizmente você ERROU o nº que o Sr. Kapecula está á pensar é maior. `
        sticker.src = sad
        document.querySelector("#ti-kapecula").style = "animation: agita-agita-abana-abana .5s ease-in-out 1s alternate infinite;"
        
    } else {                                    // CLAUSULA SE FOR MAIOR
        
        saida.innerHTML = ` infelizmente você ERROU o nº que o Sr. Kapecula está á pensar é menor. `
        sticker.src = sad
        document.querySelector("#ti-kapecula").style = "animation: agita-agita-abana-abana .5s ease-in-out 1s alternate infinite;"
